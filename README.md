...
## !!!중요!!! 6월 6일부터 번역 사이트를 여기서 [Paratranz](https://paratranz.cn/projects/2445)로 이주합니다.
  - 회원가입 따로 할 필요없이 깃허브 계정으로 로그인 가능
  - 번역칸 자동생성(큰따옴표 실수로 빼먹어서 오류나고 그런일 이제 안생김)
  - 단어장 기능, 번역하려는 문장과 유사한 문장 표시 기능으로 번역시 좀더 통일성 있게 할 수 있음
  - 번역 후 승인 없이 바로 파일에 반영됨. 번역률도 실시간 확인가능
  - 등등의 장점이 있어서 여기로 이주하고자 합니다. 혹시 다른 의견 있으시면 이슈 탭이나 디씨eaw갤에 글 남겨주세요! 당분간은 깃허브 번역도 계속 받겠습니다.
